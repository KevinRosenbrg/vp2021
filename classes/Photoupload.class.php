<?php
	...
	class Photoupload {
		...
		public function save_orig($photo_orig_upload_dir, $file_name) {
			$notice = null;
			//kopeerime pildi originaalkujul, originaalnimega vajalikku kataloogi
            if(move_uploaded_file($this->photo_to_upload["tmp_name"], $photo_orig_upload_dir .$file_name)){
		...
		public function store_photo_data($image_file_name, $alt, $privacy){
			$notice = null;
